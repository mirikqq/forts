<script setup>
  ...
  const threads = ref(1);
  const statistic = ref(store.statistic);
  ...
  <div class="aside">
    ...
    <div class="actions">
      <el-button
        ...
        >{{ $t("controll.start") }}</el-button
      >
      <el-button
        plain
        class="action__button"
        >{{ $t("controll.stop") }}</el-button
      >
      <div class="threads">
    ...
    <div class="statistic">
      <div class="base__stats">
        <div class="stat">
          ...
          <span class="stat__value">{{ statistic.lines }}</span>
        </div>
        <div class="stat">
          <span class="stat__name">{{ $t("statistic.left") }}</span>
          <span class="stat__value">{{ statistic.left }}</span>
        </div>
        <div class="stat">
          <span class="stat__name">{{ $t("statistic.goods") }}</span>
          <span class="stat__value">{{ statistic.goods }}</span>
        </div>
        <div class="stat">
          <span class="stat__name">{{ $t("statistic.bads") }}</span>
          <span class="stat__value">{{ statistic.bads }}</span>
        </div>
        <div class="stat">
          <span class="stat__name">{{ $t("statistic.rares") }}</span>
          <span class="stat__value">{{ statistic.rares }}</span>
        </div>
        <div class="stat">
          <span class="stat__name">2FA</span>
          <span class="stat__value">{{ statistic["2fa"] }}</span>
        </div>
        <div class="stat">
          <span class="stat__name">{{ $t("statistic.errors") }}</span>
          <span class="stat__value">{{ statistic.errors }}</span>
        </div>
        <div class="stat">
          <span class="stat__name">{{ $t("statistic.proxy") }}</span>
          <span class="stat__value">{{ statistic.proxies }}</span>
        </div>
      </div>
    </div>
    <div class="progress__bar">
      <el-progress
        :percentage="statistic.progress"
        :stroke-width="10"
        striped
      />
    </div>
